        ...
        >
          ...
          >
            <Image
              src={profile}
              priority
              alt="Ratnesh's headshot"
              data-blobity-tooltip="I'm Batman"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Full-Stack Web Engineer and Product Designer, prev at{" "}
            <Link
              href="https://linktr.ee/_.able_"
              target="_blank"
              className="underline underline-offset-2 hover:no-underline"
              aria-label="Able Website"
            >
              Able,
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on development and blockchain, working remotely from Bhopal(M.P.),
            India.
          </p>
        </motion.div>
      </div>
